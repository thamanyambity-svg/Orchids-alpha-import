...
Compatible avec Vercel, Netlify ou tout hébergeur supportant Next.js. Configurer les variables d'environnement en production et mettre à jour `NEXT_PUBLIC_APP_URL` et `STRIPE_WEBHOOK_SECRET` (webhook Stripe en prod).
