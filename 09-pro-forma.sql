...
-- Contrôle : 2 lignes — quotes_buyer_select et quotes_partner_select, toutes deux SELECT.
-- (quotes_admin_all reste inchangée.)
SELECT policyname, cmd
FROM pg_policies
WHERE schemaname = 'public' AND tablename = 'quotes' AND policyname LIKE 'quotes_%' AND policyname <> 'quotes_admin_all'
ORDER BY policyname;
