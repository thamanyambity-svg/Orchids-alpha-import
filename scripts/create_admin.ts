...
const adminPassword = process.env.ADMIN_PASSWORD // obligatoire, plus de valeur par défaut
...
if (!adminPassword || adminPassword.length < 12) {
  console.error('❌ ADMIN_PASSWORD requis (≥ 12 caractères). Aucun mot de passe par défaut.')
  console.error('   Exemple: ADMIN_PASSWORD="VotreMotDePasseFort" npx tsx scripts/create_admin.ts')
  process.exit(1)
}
