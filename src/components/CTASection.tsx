    ...
    <section className="py-32 px-6 relative overflow-hidden" style={{ background: "hsl(216 45% 4%)" }}>
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
          <p className="font-condensed text-xs text-gold tracking-[0.5em] uppercase mb-4">Prêt à transformer votre supply chain ?</p>
          <h2 className="font-display text-[12vw] md:text-[7vw] lg:text-[6vw] text-white leading-none mb-8">REJOIGNEZ <span className="text-gradient-gold">L&apos;EXCELLENCE</span></h2>
          <p className="font-sans text-base text-white/40 max-w-lg mx-auto mb-10">Plus de 1 200 entreprises partenaires nous font déjà confiance pour leurs importations. Rejoignez le réseau Alpha Import dès aujourd&apos;hui.</p>
