...
const stats = [
  ...
  { val: "5 000+", label: "Conteneurs traités" },
  { val: "98%", label: "Livraisons à temps" },
]
    ...
    <section className="py-24 px-6 relative overflow-hidden" style={{ background: "hsl(216 45% 4%)" }}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="mb-16 text-center">
          <p className="font-condensed text-xs text-gold tracking-[0.5em] uppercase mb-3">Chiffres clés</p>
          <h2 className="font-display text-[12vw] md:text-[8vw] lg:text-[6vw] text-white leading-none">ALPHA IMPORT <span className="text-gradient-gold">EN CHIFFRES</span></h2>
        </motion.div>
