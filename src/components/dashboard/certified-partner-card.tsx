...
export function CertifiedPartnerCard() {
  return (
      ...
      <div className="glass rounded-3xl overflow-hidden p-6">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] text-muted-foreground uppercase tracking-widest leading-none mb-1">Deer emonte O'tsers AN</p>
              <h3 className="text-sm font-bold tracking-widest uppercase">Partenaire Certifié</h3>
            </div>
          </div>
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h4 className="text-lg font-bold text-white tracking-tight">OrientTrade Inc.</h4>
            <div className="flex items-center gap-2">
              <span className="text-[10px] text-muted-foreground uppercase">Dubai UALE</span>
