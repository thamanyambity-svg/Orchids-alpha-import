            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <Badge
                    className={`text-[10px] ${profile?.status === 'VERIFIED' ? 'bg-green-500/10 text-green-500 border-green-500/20' : ''}`}
                    variant={profile?.status === 'VERIFIED' ? 'outline' : 'outline'}
                  >
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant="outline"
                    className={`h-6 ${profile?.status === 'VERIFIED' ? 'bg-green-500/10 text-green-500 border-green-500/20' : ''}`}
                  >
                    {profile?.status === 'VERIFIED' ? 'Vérifié' : 'Non vérifié'}
                  </Badge>
                </div>
